...
class Block:
    ...
    def genesis():
        ...
        #        GENESIS_DATA['data']
        #        )
        return Block(**GENESIS_DATA)       # same as above commented-out
    ...
    def adjust_difficulty(last_block, new_timestamp):
        '''
        Calculate the adjusted difficulty accoring to the MINE_RATE.
