...
class Blockchain:
    ...
    Implemented as a list of blovks - data sets of transactions
    '''
    ...
    def replace_chain(self, chain):
        '''
        Replace local chain with the incoming on if the following applies:
            ...
            for transactions_json in block.data:
                ...
                if transaction.input == MINING_REWARD_INPUT:
                    ...
                    if historic_balance != transaction.input['amount']:
                        raise Exception(f'Transastion {transaction.id} has an '\
