...
class Transaction:
    '''
    Document of an exchange in currency froma a sender to
    ...
    def create_input(self, sender_wallet, output):
        '''
        Structre the input data for the transaction.
    ...
    def from_json(transaction_json):
        '''
        Deserialize a transaction's json representatin back into
        a Transaction()
        '''
    ...
    def is_valid_transaction(transaction):
        '''
        Validate a transsction.
        Raise an exeption for inalid transactions.
        '''
